...
% -- Educación en línea --
	\include{marco_teorico/educacion_en_linea}
	\include{marco_teorico/corrientes_pedagogicas}
	\include{marco_teorico/learning_objects}
% -- Web 2.0 -- 
	\include{marco_teorico/web2}
	\include{marco_teorico/accesibilidad}
% -- Metodología -- 
	\include{marco_teorico/metodologia}
% -- MVC --
	\include{marco_teorico/mvc}

% -- Metáfora del sistema --
	\include{diseno/metafora_roles}
	\include{diseno/historias_usuario}
	\include{diseno/req_no_funcionales}

% -- Marco Tecnológico --
	\include{marco_tecnologico/entorno}
...
% -- apendices
	\appendix
	\include{apendices/usuarios}
	\include{apendices/caracteristicas_sistema}
	% -- Información Complementaria --
	\include{apendices/informacion_complementaria}
		\include{apendices/accesibilidad}
	\include{apendices/comparativa}


%Manual del programador
	\include{apendices/manual_prog}
